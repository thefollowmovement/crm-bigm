...
// Finances (étape 52) : les impayés se suivent dans le journal comptable.
...
export function startScheduler() {
  ...
  console.log(
    "[jobs] Planificateur démarré (05h30 db-backup, 06h00 contract-expiry, 06h25 action-plan-overdue, 06h40 audit-overdue, 06h50 comm-task-overdue, 07h00 opening-late, 07h10 prospect-followup, 07h20 purchase-anomaly — Europe/Paris)."
  );
}
